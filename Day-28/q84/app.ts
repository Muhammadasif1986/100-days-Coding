...
// Write a function that takes a sentence and replaces all instances
...
// Trying
let replaceWord = (word:string):string=>{
     let replace =word.replace(/birmani/g, "Biryani");

     return replace
}

console.log(replaceWord(`hum nay Al Madina ki D Beaf birmani khai bhohat mazee ki hai.`)); //birmani replace to Biryani
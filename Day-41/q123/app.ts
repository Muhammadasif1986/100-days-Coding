...
// logUntilVowel("syzogy"); // Logs 's', 'y', 'z', 'y', and then 'First vowel found: y'
// // Demonstrates iterating through a string and stopping at the first vowel.

let vowel=(str:string):void => {
let vowelSet:string = "aeiouAEIOU";
for(let character of str){
  if(vowelSet.includes(character)){
    console.log(`found vowel latter ${character}`);
    break;

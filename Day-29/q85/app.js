...
// Write a function that locates the first occurrence of the
...
// trying
var findPosition = function (str) {
    var index = str.indexOf("Asif");
    return index;
};
console.log(findPosition("my name is Muhammad Asif and i study typescript")); // Ans 20
